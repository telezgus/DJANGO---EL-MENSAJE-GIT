      ...
      var aclaraciones = document.getElementById('recipient-mensaje');
      var botoncompra = document.getElementsByClassName('btnsubasta');
      var obra = document.getElementById('recipient-obra');
      ...
      function validaApellido(){
        ...
        for (var i=0; i < botoncompra.length; i++) {
          
          botoncompra[i].onclick = function(e){
              
              obra.value = e.target.name;
          }
          };